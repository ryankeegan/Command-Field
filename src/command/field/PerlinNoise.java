...
public class PerlinNoise {
    ...
    public static int GetHeight(int _xPos, int _yPos, int seed) {
        double dx = (double) _xPos / Window.getActualWindowWidth();
        double dy = (double) _yPos / Window.getActualWindowHeight();
        int frequency = 3;
        double noise = noise((dx * frequency) + seed, (dy * frequency) + seed);
        noise = (noise - 1) / 2;
        return(-(int)(noise * 0xFF));
    }
